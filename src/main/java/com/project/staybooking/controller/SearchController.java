...
import com.project.staybooking.exception.InvalidSearchDateException;
import org.springframework.web.bind.annotation.RestController;

import com.project.staybooking.model.Stay;
import com.project.staybooking.service.SearchService;
...
public class SearchController {
    ...
    public List<Stay> searchStays(
            // 放在url的？后面
            @RequestParam(name = "guest_number") int guestNumber, // 从request里拿值
